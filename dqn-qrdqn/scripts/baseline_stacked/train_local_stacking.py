...
class MinAtarCNN(BaseFeaturesExtractor):
    def __init__(self, observation_space: gym.spaces.Box, features_dim: int = 128):
        ...
        # Compute the flattened shape dynamically 
        with th.no_grad():
            n_flatten = self.cnn(
...
def main():
    ...
    model_save_dir = root_dir / "dqn" / "models" / "stacked"
    
    model_save_dir.mkdir(parents=True, exist_ok=True)

    # Setup Stacked Environment
    def make_env():
    ...
    TIMESTEPS = 1_000_000
    RUN_NAME = "DQN_Stacked_Tuned_1mil3" 
    ...
    print(f"Initializing Frame Stacked Model: {RUN_NAME}...")
